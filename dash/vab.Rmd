...
```{r}
df <- read.csv('/home/vardan/Documents/pdk_130/mos/sp_data/nvab3d.csv')
df<-df[2: 62]
...
```{r}
df <- read.csv('/home/vardan/Documents/pdk_130/mos/sp_data/vabnmos.csv')
...
```{r}
df <- read.csv('/home/vardan/Documents/pdk_130/mos/sp_data/vabpmos.csv')
